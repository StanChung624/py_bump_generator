...
class VBumpUI(QMainWindow):
    def __init__(self, logic: VBumpLogic):
        ...
        create_box = QGroupBox("📐 Pattern Generation")
        form_create = QFormLayout(create_box)
        self.btn_create_pitch = QPushButton("Grid by Pitch")
        self.btn_create_count = QPushButton("Grid by Count")
        form_create.addRow(self.btn_create_pitch, self.btn_create_count)
        layout.addWidget(create_box)

        mod_box = QGroupBox("🔧 Edit & Transform")
        mlayout = QFormLayout(mod_box)
        self.btn_modify_diam = QPushButton("Edit Diameter")
        self.btn_modify_height = QPushButton("Edit Height")
        self.btn_move = QPushButton("Move/Duplicate")
        ...
        exp_box = QGroupBox("📤 Export Meshes")
        explayout = QHBoxLayout(exp_box)
        self.btn_weldline = QPushButton("Export Weldline (WDL)")
        self.btn_airtrap = QPushButton("Export Airtrap (WDL)")
        ...
        self.btn_plot = QPushButton("Render 3D Plot")
        self.btn_view_top = QPushButton("Top (XY)")
        self.btn_view_front = QPushButton("Front (XZ)")
        self.btn_view_right = QPushButton("Side (YZ)")
        self.btn_view_default = QPushButton("Isometric")
        view_btn_layout.addWidget(self.btn_plot)
